  ...
  return (
    ...
    <section className="header-section">
      <nav className="navbar navbar-expand-lg" style={{backgroundColor:'transparent', pointerEvents:"all"}} data-bs-theme="dark">
        <div className="container-fluid">
          <a className={"navbar-brand " + archivoBlack.className} style={{fontSize:'2rem'}} href="#">Brian Torres</a>
          <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
            <span className="navbar-toggler-icon"></span>
          </button>
          <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div className="navbar-nav">
              <a className={"nav-link active " + archivoBlack.className} aria-current="page" href="#">Home</a>
              <a className={"nav-link " + archivoBlack.className} href="#">Features</a>
              <a className={"nav-link " + archivoBlack.className} href="#">Pricing</a>
            </div>
          </div>
        </div>
      </nav>
      <div className="row text-white text-center align-items-center justify-content-center">
        ...
        <div className="col-xl-4">
          <img src="me/_MG_4044.png" className="my-img img-fluid"/>
        </div>
      </div>
    </section>
    </div>
